# -*- coding: utf-8 -*-
"""
Created on Tue Mar 31 22:31:57 2015
...
while (erros < 6 ):
    ...
    if erros==6:
        tartaruga.penup()
        tartaruga.setpos(40,15)
        tartaruga.pendown()
        tartaruga.write("Perdeu",font=("Arial",17))
    ...
    if acertos==len(z):
        tartaruga.penup()
        tartaruga.setpos(55,15)
        tartaruga.pendown()
        tartaruga.write("Ganhou",font=("Arial",17))